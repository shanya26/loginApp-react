const NOTIF_SEND = 'app/notifs/NOTIF_SEND';
const NOTIF_DISMISS = 'app/notifs/NOTIF_DISMISS';
const NOTIF_CLEAR = 'app/notifs/NOTIF_CLEAR';
const NOTIF_CLEAR_ALL = 'app/notifs/NOTIF_CLEAR_ALL';
